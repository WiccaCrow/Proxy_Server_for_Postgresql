...
[Сборка](#make) \
[Запуск](#run) \
[Логирование запросов](#logs) \
[Тестирование прокси сервера](#tests) \
...
Посторонние символы и несуществующие параметры делают конфигурационный файл недействительным.
...
```sh
pgbench -i mydb
pgbench -U postgres -c 16 -j 16 -T 300 -r -n --host=localhost --port=8080 -b tpcb-like mydb
```
###### [вернуться к содержанию](#content)
<a name="links"></a> 
